...
export function Register() {
  ...
  <div class="col-md-6">
    ...
    <input type="email" class="form-control" id="validationEmail" value="Otto@example.com" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
  ...
  <div class="col-12">
    ...
    `;
	//asynchroniczne wywoływanie funkcjii , jak wykorzystac funckję async w addEventListner w czystym js MSDN 
